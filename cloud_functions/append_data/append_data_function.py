...
def google_sheet_data_to_postgres(request):
    try:
        ...
        fetch_data_from = conf['fetch_from']
        employee_table_data = get_google_sheet_data(fetch_data_from)
...
def get_google_sheet_data(fetch_data_from):
    ...
    delete_query = "SELECT employee_id, employee_first_name, employee_last_name, " \
                   ...
                   f"employee_salary_currency FROM `{table_name}` WHERE created_timestamp > '{fetch_data_from}' "
